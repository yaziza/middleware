...
public class EmployeeNativeClient extends javax.swing.JFrame implements MobileClient {
	...
	private final EmployeeClientProxy clientProxy = new EmployeeClientProxy(this);
	private MobileManagementRemote mobileManagment;
	private final SnapshotRingBuffer preparedSnapshots = new SnapshotRingBuffer(5);
	...
	public boolean updateToSnapshot(final Integer id) {
		final Snapshot snap = preparedSnapshots.getSnapshot(id);
		if (snap == null) {
			return false;
		}
